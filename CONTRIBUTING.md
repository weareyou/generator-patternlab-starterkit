# Contributing to Generator Pattern Lab Starterkit
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/generator-patternlab-starterkit
   # Navigate to the newly cloned directory
   cd generator-patternlab-starterkit
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/colours/generator-patternlab-starterkit
   ```
